...
router.get(
  "/scheduled",
  authenticate,
  workoutController.getUserScheduledWorkouts
);
router.get(
  "/scheduled/:id",
  authenticate,
  workoutController.getScheduledWorkoutById
);
router.put(
  "/scheduled/:id",
  authenticate,
  workoutController.updatedScheduledWorkout
);
router.delete(
  "/scheduled/:id",
  authenticate,
  workoutController.deleteScheduledWorkout
);
...
router.get(
  "/scheduled/:scheduledWorkoutId/logs",
  authenticate,
...
router.get(
  "/completed/:workoutId",
  authenticate,
  workoutController.getCompletedWorkoutWithLogs
);
